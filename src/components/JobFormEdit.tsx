...
export default function JobFormEdit({ initialData }: JobFormEditProps) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      jobContractType: initialData.jobContractType || '',
      jobSeniority: initialData.jobSeniority || '',
      hasSalaryInfo: initialData.hasSalaryInfo || '',
      companyName: initialData.companyName || '',
      companyDomain: initialData.companyDomain || '',
      companyDocument: initialData.companyDocument || '',
      subscriptionAction: initialData.subscriptionAction || '',
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="py-10 space-y-10">
      <div className="space-y-2">
        <h1 className="text-3xl font-semibold">Editar vaga</h1>
        <p className="text-muted-foreground">
          Atualize os dados da sua vaga
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[35%_auto] gap-8 items-start">
          ...
          <div className="grid gap-6">
            ...
            <Tiptap
              ...
              onChange={(md) => formik.setFieldValue('body', md)}
            />
          </div>
        </div>
