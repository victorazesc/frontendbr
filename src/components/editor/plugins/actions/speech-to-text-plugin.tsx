...
declare global {
  interface Window {
    SpeechRecognition: new () => BasicSpeechRecognition;
    webkitSpeechRecognition: new () => BasicSpeechRecognition;
  }
}
...
function SpeechToTextPluginImpl() {
  ...
  }, [editor, isEnabled, isClient, report])
  ...
  if (!isClient) return null // ⛔️ evita renderizar no SSR
